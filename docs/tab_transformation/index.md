...
Детальніше у розділі [Перетворення - створення номінальних та мультиваріантних ознак](make_nj.md)

## Створення метричних ознак

Формат команди обчислення значення для метричної ознаки:

`{Формула для значення} {формула фільтра}`

Детальніше у розділі [Перетворення - створення метричних ознак](make_m.md)
